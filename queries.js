  ...
  */
    ...
    */
      async function retrieveAllListings() {
          ...
          console.log('Retrieving all Listing');
      }
    /* 
   ...
   */
    ...
    */
      async function removeCable() {
         //ADD CODE HERE
        const project = await Listing.destroy({ where: { code: 'CABL' } });
    ...
    */
    async function addDSIT() {
       //ADD CODE HERE
        const project = await Listing.create({ code: 'DSIT', name: 'Data Science and IT Building' });
    ...
    */
    async function updatePhelpsLab() {
       //ADD CODE HERE
       const oriject = await Listing.update({ address: '1953 Museum Rd, Gainesville, FL 32603' }, {
        where: {
